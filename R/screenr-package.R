#' screenr
#'
#' The \pkg{screenr} package enables construction of binary test-screening
...
#' predictive of the condition.  Package \pkg{screenr} enables estimation of
...
#' @seealso
#' The high-level functions in the \pkg{screenr} package are:
#' \describe{
